...
contract Hello {
    ...
    function echo(uint no) public returns (string[] memory) {
        return themes[no].data_header;
    }
    ...
    function getTheme(uint theme_id) public returns (Theme memory) {
        return themes[theme_id];
    }
     
    function getData(uint theme_id) public returns (string[] memory) {
